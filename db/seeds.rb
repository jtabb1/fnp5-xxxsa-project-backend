...
userx02 = User.create!(user_name: 'Jago')
userx03 = User.create!(user_name: 'Stella')
...
Todo.create!(user_id: userx03.id, type_id: typex01.id, todo_name: "complete feature ccc on project")
Todo.create!(user_id: userx03.id, type_id: typex01.id, todo_name: "complete feature dddd on project")
